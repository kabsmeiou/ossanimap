...
class Pack(BaseModel):
    ...
    created_at: str = Field(..., description="ISO 8601 timestamp of pack creation")
...
class PackCreateRequest(BaseModel):
    ...
    mode: Optional[int] = Field(default=None, description="Game mode: 0=standard, 1=taiko, 2=catch, 3=mania, None=all")
